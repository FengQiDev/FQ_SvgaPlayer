...
Pod::Spec.new do |s|
  ...
  s.homepage     = 'https://github.com/FengQiDev/FQ_SvgaPlayer'
  s.description  = <<-DESC
  ...
  s.platform     = :ios, "10.0"
  s.source       = { :git => "https://github.com/FengQiDev/FQ_SvgaPlayer.git", :tag => s.version }
